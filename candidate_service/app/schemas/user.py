...
HrStatus = Literal[
    ...
    "admin_request_pending", "mapped", "suspended"
]
...
class CandidateProfileOut(UserOut): 
    ...
    full_name: Optional[str] = None # Add field
    phone_number: Optional[str] = None # Add field
    linkedin_profile: Optional[str] = None # Add field
...
class CandidateProfileUpdate(BaseModel):
    ...
    # Add other fields that should be updatable by the candidate
